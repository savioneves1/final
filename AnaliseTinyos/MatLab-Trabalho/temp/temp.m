...
axes(handles.axes9);
image(imread('../temp/unb.png','png'));
axis off;
axes(handles.axes7);
image(imread('../temp/grafo.png','png'));
axis off;
end
...
try
    ...
    if(handles.index2~=0)
        ...
        M=textread(strcat(handles.pasta2,handles.data2),'%2c');
        M=hex2dec(char(M));
        n=10; % number of columns
        M=reshape(M,n,[])';
        temp0=M(:,9);
        temp1=M(:,10);
        temp0=bitshift(temp0,8);
        temp=temp0+temp1;
        M=temp;
        M=M';
...
function h1 = temp_LayoutFcn(policy)
...
'Callback',@(hObject,eventdata)temp('bot_plot_Callback',hObject,eventdata,guidata(hObject)),...
'FontSize',14,...
...
'FontUnits','pixels',...
'BackgroundColor',[0.67843137254902 0.92156862745098 1],...
'Callback',@(hObject,eventdata)temp('limp_Callback',hObject,eventdata,guidata(hObject)),...
'FontSize',14,...
...
h9 = uimenu(...
'Parent',h1,...
'Callback',@(hObject,eventdata)temp('Arquivo_Callback',hObject,eventdata,guidata(hObject)),...
'Label','Arquivo',...
'Tag','Arquivo',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
h10 = uimenu(...
'Parent',h9,...
'Callback',@(hObject,eventdata)temp('Novo_Callback',hObject,eventdata,guidata(hObject)),...
'Label','Novo',...
'Tag','Novo',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
h11 = uimenu(...
'Parent',h9,...
'Callback',@(hObject,eventdata)temp('Sair_Callback',hObject,eventdata,guidata(hObject)),...
'Label','Sair',...
'Tag','Sair',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
h12 = uimenu(...
'Parent',h1,...
'Callback',@(hObject,eventdata)temp('Ajuda_Callback',hObject,eventdata,guidata(hObject)),...
'Label','Ajuda',...
'Tag','Ajuda',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
'FontUnits','pixels',...
'BackgroundColor',[0.67843137254902 0.92156862745098 1],...
'Callback',@(hObject,eventdata)temp('audio_bot_Callback',hObject,eventdata,guidata(hObject)),...
'FontSize',14,...
...
elseif local_isInvokeHGCallback(gui_State, varargin{:})
    % TEMP('CALLBACK',hObject,eventData,handles,...)
    gui_Create = false;
else
    % TEMP(...)
