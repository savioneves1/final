...
typedef TMilli RadioDctTempC__MilliTimer2__precision_tag;
typedef TMilli RadioDctTempC__MilliTimer__precision_tag;
typedef uint16_t RadioDctTempC__Temp__val_t;
typedef TMilli RadioDctTempC__MilliTimer3__precision_tag;
...
static void RadioDctTempC__Boot__booted(void );
# 113 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
static void RadioDctTempC__RadioControl__startDone(error_t error);
#line 138
static void RadioDctTempC__RadioControl__stopDone(error_t error);
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void RadioDctTempC__MilliTimer2__fired(void );
#line 83
static void RadioDctTempC__MilliTimer__fired(void );
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void RadioDctTempC__TempSend__sendDone(
#line 103
message_t * msg, 
...
static void RadioDctTempC__Temp__readDone(error_t result, RadioDctTempC__Temp__val_t val);
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void RadioDctTempC__MilliTimer3__fired(void );
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void RadioDctTempC__CoefSend__sendDone(
#line 103
message_t * msg, 
...
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*RadioDctTempAppC.TempSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
static void /*RadioDctTempAppC.TempSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(
#line 96
message_t * msg, 
...
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*RadioDctTempAppC.CoefSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
static void /*RadioDctTempAppC.CoefSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(
#line 96
message_t * msg, 
...
RadioDctTempC__CoefPacket__getPayload(
#line 121
message_t * msg, 
...
RadioDctTempC__TempPacket__getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
static error_t RadioDctTempC__RadioControl__start(void );
#line 130
static error_t RadioDctTempC__RadioControl__stop(void );
# 46 "/opt/tinyos-2.1.2/tos/interfaces/GeneralIO.nc"
static void RadioDctTempC__PortG1__makeOutput(void );
#line 40
static void RadioDctTempC__PortG1__set(void );
static void RadioDctTempC__PortG1__clr(void );
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void RadioDctTempC__MilliTimer2__startOneShot(uint32_t dt);
#line 64
static void RadioDctTempC__MilliTimer__startPeriodic(uint32_t dt);
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t RadioDctTempC__TempSend__send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 67 "/opt/tinyos-2.1.2/tos/interfaces/Leds.nc"
static void RadioDctTempC__Leds__led0Toggle(void );
#line 89
static void RadioDctTempC__Leds__led2On(void );
# 55 "/opt/tinyos-2.1.2/tos/interfaces/Read.nc"
static error_t RadioDctTempC__Temp__read(void );
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void RadioDctTempC__MilliTimer3__startOneShot(uint32_t dt);
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t RadioDctTempC__CoefSend__send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 41 "RadioDctTempC.nc"
message_t RadioDctTempC__packett;
message_t RadioDctTempC__packetc;
bool RadioDctTempC__lockedTemp = FALSE;
bool RadioDctTempC__lockedCoef = FALSE;
int RadioDctTempC__counter = 0;
int RadioDctTempC__k;

float RadioDctTempC__temp[NREAD];
uint16_t RadioDctTempC__coef;
uint16_t RadioDctTempC__coef2;


static float *RadioDctTempC__yt[12];
static int RadioDctTempC__brseed[256];
static int RadioDctTempC__brsflg;

struct elemento *RadioDctTempC__inicio;
uint16_t RadioDctTempC__grupo = 0;

static void RadioDctTempC__BR_permute(float *x, int logm);
#line 98
static void RadioDctTempC__srrec(float *xr, float *xi, int logm);
#line 259
static inline void RadioDctTempC__srfft(float *xr, float *xi, int logm);
...
static inline void RadioDctTempC__fdctiv2(float *x, int logm, float fac);
#line 404
static void RadioDctTempC__dctrec(float *x, int logm);
#line 445
static inline void RadioDctTempC__fdct(float *x, int logm);
#line 496
static inline void RadioDctTempC__InicializaFila(struct elemento **fila);




static inline int RadioDctTempC__FilaVazia(struct elemento *fila);
...
static inline void RadioDctTempC__InsereFila(struct elemento **fila, int dadonovo);
#line 524
static int RadioDctTempC__RetiraFila(struct elemento **fila);
...
static inline void RadioDctTempC__EnviaPacotes(void );
#line 551
static inline void RadioDctTempC__Boot__booted(void );





static inline void RadioDctTempC__RadioControl__startDone(error_t err);
...
static inline void RadioDctTempC__RadioControl__stopDone(error_t err);





static inline void RadioDctTempC__MilliTimer__fired(void );



static inline void RadioDctTempC__MilliTimer2__fired(void );





static inline void RadioDctTempC__MilliTimer3__fired(void );





static inline void RadioDctTempC__Temp__readDone(error_t result, uint16_t data);
#line 614
static void RadioDctTempC__TempSend__sendDone(message_t *bufPtr, error_t error);
#line 637
static void RadioDctTempC__CoefSend__sendDone(message_t *bufPtr, error_t error);
...
message_t *msg);
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void /*RadioDctTempAppC.TempSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
static error_t /*RadioDctTempAppC.TempSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(
#line 67
message_t * msg, 
...
static void /*RadioDctTempAppC.TempSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*RadioDctTempAppC.TempSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(
#line 158
message_t * amsg, 
...
static error_t /*RadioDctTempAppC.TempSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*RadioDctTempAppC.TempSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(message_t *m, error_t err);
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void /*RadioDctTempAppC.CoefSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
static error_t /*RadioDctTempAppC.CoefSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(
#line 67
message_t * msg, 
...
uint8_t len);
# 103 "/opt/tinyos-2.1.2/tos/interfaces/AMPacket.nc"
static void /*RadioDctTempAppC.CoefSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*RadioDctTempAppC.CoefSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(
#line 158
message_t * amsg, 
...
am_id_t t);
# 53 "/opt/tinyos-2.1.2/tos/system/AMQueueEntryP.nc"
static inline error_t /*RadioDctTempAppC.CoefSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*RadioDctTempAppC.CoefSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(message_t *m, error_t err);
...
#line 65
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*RadioDctTempAppC.TempSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(message_t * msg, error_t error){
#line 110
  RadioDctTempC__TempSend__sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*RadioDctTempAppC.TempSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(m, err);
}

# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*RadioDctTempAppC.CoefSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(message_t * msg, error_t error){
#line 110
  RadioDctTempC__CoefSend__sendDone(msg, error);
#line 110
}
#line 110
# 65 "/opt/tinyos-2.1.2/tos/system/AMQueueEntryP.nc"
...
#line 65
{
  /*RadioDctTempAppC.CoefSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(m, err);
}
...
#line 100
    case 0U:
#line 100
      /*RadioDctTempAppC.TempSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(msg, error);
#line 100
      break;
#line 100
    case 1U:
#line 100
      /*RadioDctTempAppC.CoefSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(msg, error);
#line 100
      break;
#line 100
    default:
...
# 126 "/opt/tinyos-2.1.2/tos/interfaces/Packet.nc"
inline static void * RadioDctTempC__TempPacket__getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 126
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t RadioDctTempC__TempSend__send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*RadioDctTempAppC.TempSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(addr, msg, len);
#line 80
...
# 103 "/opt/tinyos-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*RadioDctTempAppC.TempSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
#line 103
#line 162
inline static void /*RadioDctTempAppC.TempSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(message_t * amsg, am_id_t t){
#line 162
...
#line 162
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*RadioDctTempAppC.TempSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
inline static error_t RadioDctTempC__RadioControl__stop(void ){
#line 130
  unsigned char __nesc_result;
#line 130
...
# 67 "/opt/tinyos-2.1.2/tos/interfaces/Leds.nc"
inline static void RadioDctTempC__Leds__led0Toggle(void ){
#line 67
  LedsP__Leds__led0Toggle();
#line 67
}
#line 67
# 564 "RadioDctTempC.nc"
static inline void RadioDctTempC__RadioControl__stopDone(error_t err)
#line 564
{
  if (err == SUCCESS) {
      RadioDctTempC__Leds__led0Toggle();
    }
}
...
#line 138
  RadioDctTempC__RadioControl__stopDone(error);
#line 138
}
#line 138
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*RadioDctTempAppC.CoefSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
inline static void /*RadioDctTempAppC.CoefSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(message_t * amsg, am_id_t t){
#line 162
  CC2420ActiveMessageP__AMPacket__setType(amsg, t);
#line 162
}
#line 162
#line 103
inline static void /*RadioDctTempAppC.CoefSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(message_t * amsg, am_addr_t addr){
#line 103
  CC2420ActiveMessageP__AMPacket__setDestination(amsg, addr);
#line 103
}
...
#line 55
{
  /*RadioDctTempAppC.CoefSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(msg, dest);
  /*RadioDctTempAppC.CoefSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(msg, 9);
  return /*RadioDctTempAppC.CoefSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(msg, len);
}

# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t RadioDctTempC__CoefSend__send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*RadioDctTempAppC.CoefSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(addr, msg, len);
#line 80
...
#line 536
  rsm = (radio_coef_msg_t *)RadioDctTempC__CoefPacket__getPayload(&RadioDctTempC__packetc, sizeof(radio_coef_msg_t ));
  if (rsm == (void *)0) {
      return;
    }

  RadioDctTempC__grupo = RadioDctTempC__grupo + 1;
  __nesc_hton_uint16(rsm->coefic.nxdata, RadioDctTempC__coef);
  __nesc_hton_uint16(rsm->coefic2.nxdata, RadioDctTempC__coef2);
  __nesc_hton_uint16(rsm->grupo.nxdata, RadioDctTempC__grupo);

  if (RadioDctTempC__CoefSend__send(AM_BROADCAST_ADDR, &RadioDctTempC__packetc, sizeof(radio_coef_msg_t )) == SUCCESS) {
      RadioDctTempC__lockedCoef = TRUE;
    }
}
...
#line 113
  RadioDctTempC__RadioControl__startDone(error);
#line 113
}
#line 113
# 120 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
...
# 53 "/opt/tinyos-2.1.2/tos/interfaces/ResourceRequested.nc"
inline static void /*TempImplP.SharedAnalogDeviceC.Arbiter.Arbiter*/ArbiterP__0__ResourceRequested__requested(uint8_t arg_0x4063eda8){
#line 53
    /*TempImplP.SharedAnalogDeviceC.Arbiter.Arbiter*/ArbiterP__0__ResourceRequested__default__requested(arg_0x4063eda8);
#line 53
}
#line 53
...
# 88 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static error_t /*ArbitratedTempDeviceP.ArbitrateRead*/ArbitratedReadC__1__Resource__request(uint8_t arg_0x4073c990){
#line 88
  unsigned char __nesc_result;
#line 88

#line 88
  __nesc_result = /*TempImplP.SharedAnalogDeviceC.Arbiter.Arbiter*/ArbiterP__0__Resource__request(arg_0x4073c990);
#line 88
...
# 55 "/opt/tinyos-2.1.2/tos/interfaces/Read.nc"
inline static error_t RadioDctTempC__Temp__read(void ){
#line 55
  unsigned char __nesc_result;
#line 55
...
#line 55
# 570 "RadioDctTempC.nc"
static inline void RadioDctTempC__MilliTimer__fired(void )
#line 570
{
  RadioDctTempC__Temp__read();
}

# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void RadioDctTempC__MilliTimer3__startOneShot(uint32_t dt){
#line 73
...
# 41 "/opt/tinyos-2.1.2/tos/interfaces/GeneralIO.nc"
inline static void RadioDctTempC__PortG1__clr(void ){
#line 41
...
# 46 "/opt/tinyos-2.1.2/tos/interfaces/GeneralIO.nc"
inline static void RadioDctTempC__PortG1__makeOutput(void ){
#line 46
  /*HplAtm128GeneralIOC.G1*/HplAtm128GeneralIOSlowPinP__9__IO__makeOutput();
#line 46
}
#line 46
# 574 "RadioDctTempC.nc"
static inline void RadioDctTempC__MilliTimer2__fired(void )
#line 574
{
  RadioDctTempC__PortG1__makeOutput();
  RadioDctTempC__PortG1__clr();
  RadioDctTempC__MilliTimer3__startOneShot(1);
}
...
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void RadioDctTempC__MilliTimer__startPeriodic(uint32_t dt){
#line 64
...
# 40 "/opt/tinyos-2.1.2/tos/interfaces/GeneralIO.nc"
inline static void RadioDctTempC__PortG1__set(void ){
#line 40
  /*HplAtm128GeneralIOC.G1*/HplAtm128GeneralIOSlowPinP__9__IO__set();
#line 40
}
#line 40
# 580 "RadioDctTempC.nc"
static inline void RadioDctTempC__MilliTimer3__fired(void )
#line 580
{
  RadioDctTempC__PortG1__makeOutput();
  RadioDctTempC__PortG1__set();
  RadioDctTempC__MilliTimer__startPeriodic(1000);
}
...
#line 83
    case 2U:
#line 83
      RadioDctTempC__MilliTimer__fired();
#line 83
      break;
#line 83
    case 3U:
#line 83
      RadioDctTempC__MilliTimer2__fired();
#line 83
      break;
#line 83
    case 4U:
#line 83
      RadioDctTempC__MilliTimer3__fired();
#line 83
      break;
#line 83
    default:
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP__1__Resource__granted(uint8_t arg_0x4063e380){
#line 102
  switch (arg_0x4063e380) {
#line 102
...
#line 102
    default:
#line 102
      /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP__1__Resource__default__granted(arg_0x4063e380);
#line 102
      break;
#line 102
    }
...
# 59 "/opt/tinyos-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP__1__ResourceConfigure__configure(uint8_t arg_0x4064d1b8){
#line 59
    /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP__1__ResourceConfigure__default__configure(arg_0x4064d1b8);
#line 59
}
#line 59
...
# 65 "/opt/tinyos-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP__1__ResourceConfigure__unconfigure(uint8_t arg_0x4064d1b8){
#line 65
    /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP__1__ResourceConfigure__default__unconfigure(arg_0x4064d1b8);
#line 65
}
#line 65
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
...
# 53 "/opt/tinyos-2.1.2/tos/interfaces/ResourceRequested.nc"
inline static void /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP__1__ResourceRequested__requested(uint8_t arg_0x4063eda8){
#line 53
    /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP__1__ResourceRequested__default__requested(arg_0x4063eda8);
#line 53
}
#line 53
# 77 "/opt/tinyos-2.1.2/tos/system/ArbiterP.nc"
...
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t RadioDctTempC__RadioControl__start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
inline static void RadioDctTempC__Leds__led2On(void ){
#line 89
  LedsP__Leds__led2On();
#line 89
}
#line 89
# 445 "RadioDctTempC.nc"
static inline void RadioDctTempC__fdct(float *x, int logm)
#line 445
{
  static float tmp;
...
#line 454
  ...
  if (RadioDctTempC__yt[logm - 1] == (void *)0) {
      if ((RadioDctTempC__yt[logm - 1] = (float *)calloc(m, sizeof(float ))) == (void *)0) {
          RadioDctTempC__Leds__led2On();
        }
    }
  y = RadioDctTempC__yt[logm - 1];


  memcpy(y, x, sizeof(float ) * m);


  RadioDctTempC__dctrec(y, logm);
...
#line 586
{
  if (RadioDctTempC__lockedTemp) {
      return;
    }
  else {
      RadioDctTempC__temp[RadioDctTempC__counter] = data;
      RadioDctTempC__counter++;
      if (RadioDctTempC__counter == NREAD) {
          RadioDctTempC__counter = 0;
          RadioDctTempC__coef = 0;
          RadioDctTempC__coef2 = 0;

          RadioDctTempC__fdct(RadioDctTempC__temp, LOG);
          RadioDctTempC__InicializaFila(&RadioDctTempC__inicio);
          for (RadioDctTempC__k = 0; RadioDctTempC__k < NREAD; RadioDctTempC__k++) {
              if ((int )RadioDctTempC__temp[RadioDctTempC__k] != 0) {
                  if (RadioDctTempC__k < 16) {
                    RadioDctTempC__coef |= 1 << RadioDctTempC__k;
                    }
#line 604
                  if (RadioDctTempC__k >= 16 && RadioDctTempC__k < 32) {
                    RadioDctTempC__coef2 |= 1 << (RadioDctTempC__k - 16);
                    }
#line 606
                  RadioDctTempC__InsereFila(&RadioDctTempC__inicio, (int )RadioDctTempC__temp[RadioDctTempC__k]);
                }
            }
          RadioDctTempC__RadioControl__start();
        }
    }
}
...
# 63 "/opt/tinyos-2.1.2/tos/interfaces/Read.nc"
inline static void /*ArbitratedTempDeviceP.ArbitrateRead*/ArbitratedReadC__1__Read__readDone(uint8_t arg_0x4073ea28, error_t result, /*ArbitratedTempDeviceP.ArbitrateRead*/ArbitratedReadC__1__Read__val_t val){
#line 63
  switch (arg_0x4073ea28) {
#line 63
    case 0U:
#line 63
      RadioDctTempC__Temp__readDone(result, val);
#line 63
      break;
#line 63
    default:
#line 63
      /*ArbitratedTempDeviceP.ArbitrateRead*/ArbitratedReadC__1__Read__default__readDone(arg_0x4073ea28, result, val);
#line 63
      break;
#line 63
    }
...
# 65 "/opt/tinyos-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*TempImplP.SharedAnalogDeviceC.Arbiter.Arbiter*/ArbiterP__0__ResourceConfigure__unconfigure(uint8_t arg_0x4064d1b8){
#line 65
    /*TempImplP.SharedAnalogDeviceC.Arbiter.Arbiter*/ArbiterP__0__ResourceConfigure__default__unconfigure(arg_0x4064d1b8);
#line 65
}
#line 65
# 57 "/opt/tinyos-2.1.2/tos/system/RoundRobinResourceQueueC.nc"
...
# 120 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static error_t /*ArbitratedTempDeviceP.ArbitrateRead*/ArbitratedReadC__1__Resource__release(uint8_t arg_0x4073c990){
#line 120
  unsigned char __nesc_result;
#line 120

#line 120
  __nesc_result = /*TempImplP.SharedAnalogDeviceC.Arbiter.Arbiter*/ArbiterP__0__Resource__release(arg_0x4073c990);
#line 120
...
# 63 "/opt/tinyos-2.1.2/tos/interfaces/Read.nc"
inline static void /*TempImplP.SharedAnalogDeviceC.AnalogDevice*/SharedAnalogDeviceP__0__Read__readDone(uint8_t arg_0x40684a88, error_t result, /*TempImplP.SharedAnalogDeviceC.AnalogDevice*/SharedAnalogDeviceP__0__Read__val_t val){
#line 63
  /*ArbitratedTempDeviceP.ArbitrateRead*/ArbitratedReadC__1__Service__readDone(arg_0x40684a88, result, val);
#line 63
}
#line 63
...
# 259 "RadioDctTempC.nc"
static inline void RadioDctTempC__srfft(float *xr, float *xi, int logm)
#line 259
{

  RadioDctTempC__srrec(xr, xi, logm);


  if (logm > 1) {
      RadioDctTempC__BR_permute(xr, logm);
      RadioDctTempC__BR_permute(xi, logm);
    }
}
...
#line 336
  ...
  if (RadioDctTempC__yt[logm - 1] == (void *)0) {
      if ((RadioDctTempC__yt[logm - 1] = (float *)calloc(m2, sizeof(float ))) == (void *)0) {
          RadioDctTempC__Leds__led2On();
        }
    }
...
#line 369
  ...
  RadioDctTempC__srfft(x, y, logm - 1);
...
# 55 "/opt/tinyos-2.1.2/tos/interfaces/Read.nc"
inline static error_t /*ArbitratedTempDeviceP.ArbitrateRead*/ArbitratedReadC__1__Service__read(uint8_t arg_0x4073dac8){
#line 55
  unsigned char __nesc_result;
#line 55

#line 55
  __nesc_result = /*TempImplP.SharedAnalogDeviceC.AnalogDevice*/SharedAnalogDeviceP__0__Read__read(arg_0x4073dac8);
#line 55
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void /*TempImplP.SharedAnalogDeviceC.Arbiter.Arbiter*/ArbiterP__0__Resource__granted(uint8_t arg_0x4063e380){
#line 102
  /*ArbitratedTempDeviceP.ArbitrateRead*/ArbitratedReadC__1__Resource__granted(arg_0x4063e380);
#line 102
}
#line 102
# 216 "/opt/tinyos-2.1.2/tos/system/ArbiterP.nc"
...
# 59 "/opt/tinyos-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*TempImplP.SharedAnalogDeviceC.Arbiter.Arbiter*/ArbiterP__0__ResourceConfigure__configure(uint8_t arg_0x4064d1b8){
#line 59
    /*TempImplP.SharedAnalogDeviceC.Arbiter.Arbiter*/ArbiterP__0__ResourceConfigure__default__configure(arg_0x4064d1b8);
#line 59
}
#line 59
# 190 "/opt/tinyos-2.1.2/tos/system/ArbiterP.nc"
...
#line 62
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void RadioDctTempC__MilliTimer2__startOneShot(uint32_t dt){
#line 73
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__startOneShot(3U, dt);
#line 73
}
#line 73
# 551 "RadioDctTempC.nc"
static inline void RadioDctTempC__Boot__booted(void )
#line 551
{
  RadioDctTempC__PortG1__makeOutput();
  RadioDctTempC__PortG1__set();
  RadioDctTempC__MilliTimer2__startOneShot(1);
}

# 60 "/opt/tinyos-2.1.2/tos/interfaces/Boot.nc"
inline static void RealMainP__Boot__booted(void ){
#line 60
  RadioDctTempC__Boot__booted();
#line 60
}
#line 60
...
#line 75
# 637 "RadioDctTempC.nc"
static void RadioDctTempC__CoefSend__sendDone(message_t *bufPtr, error_t error)
#line 637
{
  if (&RadioDctTempC__packetc == bufPtr) {
      if (RadioDctTempC__lockedCoef == TRUE) {
          radio_sense_msg_t *rsm;

          RadioDctTempC__lockedCoef = FALSE;


          rsm = (radio_sense_msg_t *)RadioDctTempC__TempPacket__getPayload(&RadioDctTempC__packett, sizeof(radio_sense_msg_t ));
          if (rsm == (void *)0) {
              return;
            }
          __nesc_hton_int16(rsm->dataint.nxdata, RadioDctTempC__RetiraFila(&RadioDctTempC__inicio));
          __nesc_hton_uint16(rsm->grupo.nxdata, RadioDctTempC__grupo);
          if (RadioDctTempC__TempSend__send(AM_BROADCAST_ADDR, &RadioDctTempC__packett, sizeof(radio_sense_msg_t )) == SUCCESS) {
              RadioDctTempC__lockedTemp = TRUE;
            }
        }
    }
}
...
#line 55
{
  /*RadioDctTempAppC.TempSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(msg, dest);
  /*RadioDctTempAppC.TempSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(msg, 7);
  return /*RadioDctTempAppC.TempSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(msg, len);
}
...
#line 56
# 614 "RadioDctTempC.nc"
static void RadioDctTempC__TempSend__sendDone(message_t *bufPtr, error_t error)
#line 614
{
  if (&RadioDctTempC__packett == bufPtr) {
      if (RadioDctTempC__lockedTemp == TRUE) {
          RadioDctTempC__lockedTemp = FALSE;
          if (!RadioDctTempC__FilaVazia(RadioDctTempC__inicio)) {
              radio_sense_msg_t *rsm;
...
#line 620
          ...
          if (RadioDctTempC__FilaVazia(RadioDctTempC__inicio)) {
              RadioDctTempC__RadioControl__stop();
            }
        }
    }
}
...
# 126 "/opt/tinyos-2.1.2/tos/interfaces/Packet.nc"
static void * RadioDctTempC__CoefPacket__getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 435
  ...
  RadioDctTempC__fdctiv2(x + m2, logm - 1, sqrt(m2));


  RadioDctTempC__dctrec(x, logm - 1);
}
...
#line 246
  ...
  RadioDctTempC__srrec(xr, xi, logm - 1);
...
#line 253
  m2 = m / 2;
  RadioDctTempC__srrec(xr + m2, xi + m2, logm - 2);
  m = 1 << logm;
#line 255
  m4 = 3 * (m / 4);
  RadioDctTempC__srrec(xr + m4, xi + m4, logm - 2);
}
...
#line 67
  ...
  if (RadioDctTempC__brsflg != logm) {
      RadioDctTempC__brsflg = logm;
      RadioDctTempC__brseed[0] = 0;
      RadioDctTempC__brseed[1] = 1;
      for (j = 2; j <= lg2; j++) {
          imax = 1 << (j - 1);
          for (i = 0; i < imax; i++) {
              RadioDctTempC__brseed[i] <<= 1;
              RadioDctTempC__brseed[i + imax] = RadioDctTempC__brseed[i] + 1;
            }
        }
    }
  ...
  for (off = 1; off < n; off++) {
      fj = n * RadioDctTempC__brseed[off];
#line 85
      i = off;
#line 85
      j = fj;
...
#line 86
      x[j] = tmp;
      xp = &x[i];
      brp = &RadioDctTempC__brseed[1];
      for (gno = 1; gno < RadioDctTempC__brseed[off]; gno++) {
          xp += n;
          j = fj + * brp++;
          xq = x + j;
          tmp = *xp;
